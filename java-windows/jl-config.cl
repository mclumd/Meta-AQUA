...
(setf javatools.jlinker:*jlinker-java-home* "/usr/local/jdk/bin/")
;;(setf javatools.jlinker:*jni-library* "jre1.6.0_24/bin/client/jvm.dll"
					;"jre1.5.0_06/bin/client/jvm.dll"
;;      )
...
(setf *JLINKER-RUN-JAVA* 'javatools.jlinker::run-java)