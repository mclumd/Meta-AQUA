...
(defpackage :poirot-connector (:nicknames :pc))
...
(setf *poirot-component* nil)
(setf *poirot-component-class* nil)
...
(setf *poirot-sample-query* "SELECT x FROM {x} rdf:type {poirot:SemanticTrace} USING NAMESPACE poirot = <http://poirot.bbn.com/2006/05/core#>, rdf = <http://www.w3.org/1999/02/22-rdf-syntax-ns#>")
...
(defun get-component-name ()
  (let ((cname-method (JMETHOD *poirot-component-class* "getComponentName")))
...
(defun set-namespace () 
  (let ((setns-method 
    ...
    (jcall setns-method *poirot-component* *poirot-component-namespace*))
  t)
...
(defun set-name () 
  (let ((setns-method 
    ...
    (jcall setns-method *poirot-component* *poirot-component-name*))
  t)

;; Set the component description
(defun set-description () 
  (let ((setns-method 
	 (JMETHOD *poirot-component-class* "setComponentDescription" 1)))
    (jcall setns-method *poirot-component* *poirot-component-description*))
  t)
