...
;; CLASSPATH setup
(defvar *poirot-jars* '("lisp\\build\\lib\\poirot-lisp.jar"
...
(defvar *poirot-sample-query* "SELECT x FROM {x} rdf:type {poirot:SemanticTrace} USING NAMESPACE poirot = <http://poirot.bbn.com/2006/05/core#>, rdf = <http://www.w3.org/1999/02/22-rdf-syntax-ns#>")
